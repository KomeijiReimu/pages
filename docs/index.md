...
Quartz requires **at least [Node](https://nodejs.org/) v22** and this KomeijiReimu project uses [Bun](https://bun.sh/) as its package manager. Ensure you have them installed on your machine before continuing.
