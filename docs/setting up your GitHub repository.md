...
In future updates, you can simply run `bun run quartz -- sync` every time you want to push updates to your repository.

> [!hint] Flags and options
> For full help options, you can run `bun run quartz -- sync --help`.
>
